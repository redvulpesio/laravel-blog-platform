            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-12">
                    <div class="title-box mb-2">
                        ...
                        <span class="d-block"><a href="{{route('home')}}">بازگشت به صفحه اصلی</a> <i class="bi bi-arrow-left position-relative"></i></span>
                    </div>
                </div>
                <div class="col-md-8 text-center">
                    <div class="not-found bg-white rounded border p-3 pb-5">
                     ...
                     404
                        ...
                        <span class="d-block my-3">بازگشت به <a href="{{route('home')}}">صفحه اصلی</a> سایت</span>
