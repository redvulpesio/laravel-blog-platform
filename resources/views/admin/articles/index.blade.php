                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <figure class="avatar avatar">
                                        <img src="{{url('images/articles/' . $article->image)}}" alt="can't found image">
                                    </figure>
                                </td>
                                <td class="text-center align-middle">{{$article->title}}</td>
                                <td class="text-center align-middle">{{$article->user->name . ' ' . $article->user->family}}</td>
                                ...
                                <td class="text-center align-middle">
                                    <a class="btn btn-outline-danger" onclick="deleteArticle({{$article->id}})"
                                       href="#">
                                        حذف
                                    </a>
                                </td>
                                <td class="text-center align-middle">{{Hekmatinasser\Verta\Verta::instance($article->created_at)->format('%d %B، %Y')}}</td>
                            </tr>
                        @endforeach
                    </table>
